<!-- resources/views/past_papers/create.blade.php -->
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Upload Past Paper') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('past-papers.store') }}" enctype="multipart/form-data">
                        @csrf
